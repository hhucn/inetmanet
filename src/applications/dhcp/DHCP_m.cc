//
// Generated file, do not edit! Created by opp_msgc 4.4 from applications/dhcp/DHCP.msg.
//
...
IPAddress& DHCPMessage::getCiaddr()
{
    return ciaddr_var;
}

void DHCPMessage::setCiaddr(const IPAddress& ciaddr)
{
    this->ciaddr_var = ciaddr;
}

IPAddress& DHCPMessage::getYiaddr()
{
    return yiaddr_var;
}

void DHCPMessage::setYiaddr(const IPAddress& yiaddr)
{
    this->yiaddr_var = yiaddr;
}

IPAddress& DHCPMessage::getGiaddr()
{
    return giaddr_var;
}

void DHCPMessage::setGiaddr(const IPAddress& giaddr)
{
