//
// Generated file, do not edit! Created by opp_msgc 4.4 from transport/contract/TCPCommand.msg.
//
...
void TCPOpenCommand::setSendQueueClass(const char * sendQueueClass)
{
    this->sendQueueClass_var = sendQueueClass;
}
...
void TCPOpenCommand::setReceiveQueueClass(const char * receiveQueueClass)
{
    this->receiveQueueClass_var = receiveQueueClass;
}
