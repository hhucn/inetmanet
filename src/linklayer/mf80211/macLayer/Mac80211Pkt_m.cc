//
// Generated file, do not edit! Created by opp_msgc 4.4 from linklayer/mf80211/macLayer/Mac80211Pkt.msg.
//
...
bool Mac80211PktDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setFragmentation(string2long(value)); return true;
        case 4: pp->setInformationDS(string2long(value)); return true;
        case 5: pp->setSequenceControl(string2long(value)); return true;
