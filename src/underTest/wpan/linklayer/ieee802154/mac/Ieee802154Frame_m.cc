//
// Generated file, do not edit! Created by opp_msgc 4.4 from underTest/wpan/linklayer/ieee802154/mac/Ieee802154Frame.msg.
//
...
uint64_t Ieee802154Frame::getDstPanId() const
{
    return dstPanId_var;
}

void Ieee802154Frame::setDstPanId(uint64_t dstPanId)
{
    this->dstPanId_var = dstPanId;
}

uint64_t Ieee802154Frame::getDstAddr() const
{
    return dstAddr_var;
}

void Ieee802154Frame::setDstAddr(uint64_t dstAddr)
{
    this->dstAddr_var = dstAddr;
}

uint64_t Ieee802154Frame::getSrcPanId() const
{
    return srcPanId_var;
}

void Ieee802154Frame::setSrcPanId(uint64_t srcPanId)
{
    this->srcPanId_var = srcPanId;
}

uint64_t Ieee802154Frame::getSrcAddr() const
{
    return srcAddr_var;
}

void Ieee802154Frame::setSrcAddr(uint64_t srcAddr)
{
...
std::string Ieee802154FrameDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return uint642string(pp->getDstPanId());
        case 3: return uint642string(pp->getDstAddr());
        case 4: return uint642string(pp->getSrcPanId());
        case 5: return uint642string(pp->getSrcAddr());
...
bool Ieee802154FrameDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setDstPanId(string2uint64(value)); return true;
        case 3: pp->setDstAddr(string2uint64(value)); return true;
        case 4: pp->setSrcPanId(string2uint64(value)); return true;
        case 5: pp->setSrcAddr(string2uint64(value)); return true;
