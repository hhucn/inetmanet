...
/**
 * Class generated from <tt>underTest/wpan/networklayer/contract/Ieee802154NetworkCtrlInfo.msg</tt> by opp_msgc.
 * <pre>
...
class Ieee802154NetworkCtrlInfo : public ::cMessage
{
  ...
  public:
    ...
    virtual int getNetwAddr() const;
    virtual void setNetwAddr(int netwAddr);
};
