//
// Generated file, do not edit! Created by opp_msgc 4.4 from underTest/wpan/networklayer/contract/Ieee802154NetworkCtrlInfo.msg.
//
...
int Ieee802154NetworkCtrlInfo::getNetwAddr() const
{
    return netwAddr_var;
}

void Ieee802154NetworkCtrlInfo::setNetwAddr(int netwAddr)
{
...
std::string Ieee802154NetworkCtrlInfoDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getNetwAddr());
        default: return "";
    }
}
...
bool Ieee802154NetworkCtrlInfoDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setNetwAddr(string2long(value)); return true;
