//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/rsvp_te/SignallingMsg.msg.
//
...
void HelloTimerMsg::setPeer(const IPAddress& peer)
{
    this->peer_var = peer;
}
...
void HelloTimeoutMsg::setPeer(const IPAddress& peer)
{
    this->peer_var = peer;
}
