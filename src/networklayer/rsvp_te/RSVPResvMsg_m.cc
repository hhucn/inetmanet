//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/rsvp_te/RSVPResvMsg.msg.
//
...
IPAddress& RSVPResvError_Base::getErrorNode()
{
    return errorNode_var;
}

void RSVPResvError_Base::setErrorNode(const IPAddress& errorNode)
{
