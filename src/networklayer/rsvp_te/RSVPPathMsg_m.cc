//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/rsvp_te/RSVPPathMsg.msg.
//
...
void RSVPPathError_Base::setErrorNode(const IPAddress& errorNode)
{
