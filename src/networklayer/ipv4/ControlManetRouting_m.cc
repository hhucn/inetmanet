//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/ipv4/ControlManetRouting.msg.
//
...
Uint128& ControlManetRouting::getSrcAddress()
{
    return srcAddress_var;
}

void ControlManetRouting::setSrcAddress(const Uint128& srcAddress)
{
    this->srcAddress_var = srcAddress;
}

Uint128& ControlManetRouting::getDestAddress()
{
    return destAddress_var;
}

void ControlManetRouting::setDestAddress(const Uint128& destAddress)
{
