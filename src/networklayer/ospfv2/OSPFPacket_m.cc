//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/ospfv2/OSPFPacket.msg.
//
...
void OSPFPacket::setPacketLength(short packetLength)
{
...
void OSPFPacket::setRouterID(const IPAddress& routerID)
{
...
void OSPFPacket::setAreaID(const IPAddress& areaID)
{
...
void OSPFPacket::setChecksum(short checksum)
{
...
void OSPFHelloPacket::setNetworkMask(const IPAddress& networkMask)
{
...
void OSPFHelloPacket::setDesignatedRouter(const IPAddress& designatedRouter)
{
...
void OSPFHelloPacket::setBackupDesignatedRouter(const IPAddress& backupDesignatedRouter)
{
...
void OSPFHelloPacket::setNeighbor(unsigned int k, const IPAddress& neighbor)
{
    if (k>=neighbor_arraysize) throw cRuntimeError("Array of size %d indexed by %d", neighbor_arraysize, k);
...
void OSPFLSAHeader::setLinkStateID(unsigned long linkStateID)
{
...
void OSPFLSAHeader::setAdvertisingRouter(const IPAddress& advertisingRouter)
{
...
void OSPFLSAHeader::setLsChecksum(short lsChecksum)
{
    this->lsChecksum_var = lsChecksum;
}
...
void Link::setLinkID(const IPAddress& linkID)
{
...
void OSPFNetworkLSA::setNetworkMask(const IPAddress& networkMask)
{
    this->networkMask_var = networkMask;
}
...
void OSPFNetworkLSA::setAttachedRouters(unsigned int k, const IPAddress& attachedRouters)
{
    if (k>=attachedRouters_arraysize) throw cRuntimeError("Array of size %d indexed by %d", attachedRouters_arraysize, k);
...
void OSPFSummaryLSA::setNetworkMask(const IPAddress& networkMask)
{
    this->networkMask_var = networkMask;
}
...
void OSPFASExternalLSAContents::setNetworkMask(const IPAddress& networkMask)
{
    this->networkMask_var = networkMask;
}
...
void OSPFASExternalLSAContents::setForwardingAddress(const IPAddress& forwardingAddress)
{
