//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/manetrouting/dsdv/DSDVhello.msg.
//
...
IPAddress& DSDV_HelloMessage::getSrcIPAddress()
{
    return srcIPAddress_var;
}

void DSDV_HelloMessage::setSrcIPAddress(const IPAddress& srcIPAddress)
{
...
IPAddress& DSDV_HelloMessage::getNextIPAddress()
{
    return nextIPAddress_var;
}

void DSDV_HelloMessage::setNextIPAddress(const IPAddress& nextIPAddress)
{
