//
// Generated file, do not edit! Created by opp_msgc 4.4 from networklayer/ldp/LDPPacket.msg.
//
...
void LDPPacket::setSenderAddress(const IPAddress& senderAddress)
{
...
void LDPPacket::setReceiverAddress(const IPAddress& receiverAddress)
{
