...
#ifndef SHADOWPROPAGATIONLOSSMODEL_H_
#define SHADOWPROPAGATIONLOSSMODEL_H_

#include "IShadowingModel.h"
#include "MapManager.h"

/**
 * This ShadowPropagationLossModel was developed in the context of Michael Oppermanns master thesis.
 ...
 * @author rpr
 */
class INET_API ShadowPropagationLossModel : public IShadowingModel {

public:
    ~ShadowPropagationLossModel() {};
...
#endif /* SHADOWPROPAGATIONLOSSMODEL_H_ */
